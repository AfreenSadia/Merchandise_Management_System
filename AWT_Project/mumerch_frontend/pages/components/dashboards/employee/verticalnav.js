        ...
        <div class="px-3 py-3 overflow-y-auto dark:bg-gray-800 bg-gray-100 rounded-md">
          ...
          <li>
              ...
              <ul id="dropdown-example" className={`${dropdownVisibleProduct ? "" : "hidden"
                ...
                <li>
                  <Link href="/dashboards/employee/productmanagement/category/categorylist"
                ...
                <li>
                  <Link href="/dashboards/employee/productmanagement/size/sizelist"
                ...
                <li>
                  <Link href="/dashboards/employee/productmanagement/color/colorlist"
                ...
                <li>
                  <Link href="/dashboards/employee/productmanagement/product/productlist"
            ...
            <li>
              <Link href="/dashboards/employee/ordermanagement/addorder"
            ...
            <li>
              ...
              <ul id="dropdown-example" className={`${dropdownVisibleReport ? "" : "hidden"
                ...
                <li>
                  <Link href="/dashboards/employee/reports/salesreport"
                ...
                <li>
                  <Link href="/dashboards/employee/reports/revenuereport"
                ...
                <li>
                  <Link href="/dashboards/employee/reports/barchart"
