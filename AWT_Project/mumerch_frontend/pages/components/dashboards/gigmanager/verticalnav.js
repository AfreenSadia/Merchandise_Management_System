          ...
          <ul class="space-y-2 font-medium">
            <li>
              ...
              <ul id="dropdown-example" className={`${dropdownVisibleUser ? "" : "hidden"
                ...
                <li>
                  <Link href="/dashboards/gigmanager/usermanagement/gigmanager/gigmanagerlist"
                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400">Gig Manager</Link>
                </li>
              </ul>
            </li>
            <li>
              <Link href="/dashboards/gigmanager/bandmanagement/bandlist"
            ...
            <li>
              <Link href="/dashboards/gigmanager/gigmanagement/giglist"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-400 bg-gray-200 group">
                <svg
            ...
            <li>
              <Link href="/dashboards/gigmanager/ordermanagement/orderlist"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-400 bg-gray-200 group">
                <svg
                  class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
              <Link href="/dashboards/gigmanager/customermanagement/customerlist"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-400 bg-gray-200 group">
                <svg
                  class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
              ...
              <ul id="dropdown-example" className={`${dropdownVisibleReport ? "" : "hidden"
                ...
                <li>
                  <Link href="/dashboards/gigmanager/reports/salesreport"
                ...
                <li>
                  <Link href="/dashboards/gigmanager/reports/revenuereport"
                ...
                <li>
                  <Link href="/dashboards/gigmanager/reports/barchart"
