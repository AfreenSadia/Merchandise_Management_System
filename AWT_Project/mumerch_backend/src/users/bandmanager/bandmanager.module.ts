...
import { BandManagerController } from './bandmanager.controller';
...
@Module({
  imports: [TypeOrmModule.forFeature([ LoginEntity, UserProfileEntity, SizeEntity, ColorEntity, ProductEntity, DesignationEntity,CustomerEntity, OrderProductsMapEntity, BandEntity, BandManagerEntity, CategoryEntity, OrderEntity, GigEntity, GigManagerEntity, OrderProductsMapEntity ])],
  controllers: [ BandManagerController ],
  providers: [ UserProfileService, SizeService, LoginService, ProductService, DesignationService, BandService, CategoryService, ColorService, CustomerService,  GigService, OrderService, OrderProductsMapService ],
})
export class BandManagerModule {}